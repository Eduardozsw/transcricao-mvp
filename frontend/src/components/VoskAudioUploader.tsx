      ...
      <div className="w-full flex flex-wrap my-10 mx-5 ">
        <div className="w-1/2 bg-gray-100 border-2 rounded-2xl">
          <div className="py-2">
            ...
            <h1 className="flex justify-center text-center text-5xl font-bold">Vosk</h1>
            <p>Maior velocidade nas suas transcrições porém menos precisão. Considere assinar o <a href="/whisper" className="text-blue-300 underline">premium</a> para uma transcrição mais precisa</p>
          </div>
          ...
          <div className="my-5">
            ...
            <select className="bg-transparent active:bg-transparent" value={idioma} onChange={(e) => setIdioma(e.target.value)}>
