      ...
      <div className="max-w-full">
        <div className="w-1/2">
          <div className="flex flex-col text-center justify-center">
            ...
            <h1 className="flex justify-center text-center text-5xl font-bold mt-10">Vosk</h1>
          ...
          <h1 className="flex justify-center text-center font-bold text-3xl pb-10 mt-10">Enviar áudio para transcrição</h1>
